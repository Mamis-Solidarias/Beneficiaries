...
/// <summary>
/// Basic configuration to use this HttpClient. It must be stored in the app settings under BeneficiariesHttpClient
/// </summary>
internal class BeneficiariesConfiguration
{
    /// <summary>
